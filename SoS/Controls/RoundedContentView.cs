...
namespace SoS.Controls
{
    public class RoundedContentView : ContentView
    {
        ...
        public static readonly BindableProperty ShadowElevationProperty = BindableProperty.Create(nameof(ShadowElevation), typeof(float), typeof(RoundedContentView), defaultValue: 0f);
